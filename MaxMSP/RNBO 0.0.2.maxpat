...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 773.0, 266.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 407.0, 87.0, 22.0 ],
					"text" : "harmonicity $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 767.0, 572.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 375.0, 205.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 315.0, 119.0, 136.0, 49.0 ],
					"size" : 8.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 61.0, 215.0, 68.0, 22.0 ],
					"text" : "t f b"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-scale-menu",
					"items" : [ "Equal (12-TET)", ",", "Just (5-limit)", ",", "Pythagorean", ",", "Meantone (1/4 comma)", ",", "Harmonic Series", ",", "Hungarian Gypsy", ",", "Equal limit", ",", "Just limit", ",", "Pythagorean limit", ",", "Meantone limit", ",", "Harmonic limit", ",", "Hungarian limit" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.0, 176.0, 190.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					"id" : "obj-harmo-menu",
					"items" : [ 1, ",", 1.33484, ",", 1.591, ",", 2.004, ",", 3.254, ",", 4.48, ",", 8.970000000000001 ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 22.0, 302.0, 87.0, 22.0 ]
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 22.0, 248.0, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 22.0, 215.0, 30.0, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.0, 248.0, 40.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 273.0, 40.0, 22.0 ],
					"text" : "iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.0, 273.0, 100.0, 22.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 341.0, 52.0, 22.0 ],
					"text" : "expr $f1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 22.0, 142.0, 20.0, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 590.0, 176.0, 49.0, 22.0 ],
					"text" : "start $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 589.0, 112.0, 90.0, 22.0 ],
					"text" : "loadmess 1024"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 589.0, 145.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 645.0, 176.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 668.0, 290.0, 62.0, 22.0 ],
					"text" : "midiflush"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 717.0, 253.0, 49.0, 22.0 ],
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 773.0, 39.0, 77.0, 22.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 780.0, 191.0, 258.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 773.0, 115.0, 61.0, 23.0 ],
					"text" : "types $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 773.0, 75.0, 145.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 773.0, 299.0, 278.5, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 773.0, 149.0, 275.0, 103.0 ],
					"types" : "Midi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.0, 175.0, 59.0, 23.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 673.0, 145.0, 66.0, 23.0 ],
					"text" : "start 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "bang", "" ],
					"patching_rect" : [ 668.0, 252.0, 40.0, 23.0 ],
					"text" : "seq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 180.0, 336.0, 32.0, 22.0 ],
					"text" : "+ 12"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 630.0, 446.0, 191.0, 22.0 ],
					"text_width" : 138.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 630.0, 418.0, 191.0, 22.0 ],
					"text_width" : 138.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 682.0, 633.0, 35.0, 22.0 ],
					"text" : "1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 641.0, 633.0, 29.5, 22.0 ],
					"text" : "100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 214.0, 34.0, 22.0 ],
					"text" : "flush"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 672.0, 187.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 646.0, 191.0, 22.0 ],
					"text_width" : 131.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 547.0, 191.0, 22.0 ],
					"text_width" : 144.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 521.0, 191.0, 22.0 ],
					"text_width" : 140.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 495.0, 191.0, 22.0 ],
					"text_width" : 138.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 469.0, 191.0, 22.0 ],
					"text_width" : 144.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 620.0, 191.0, 22.0 ],
					"text_width" : 144.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 594.0, 191.0, 22.0 ],
					"text_width" : 140.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 418.0, 191.0, 22.0 ],
					"text_width" : 138.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.0, 386.0, 191.0, 22.0 ],
					"text_width" : 144.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 180.0, 456.0, 82.0, 22.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 423.0, 54.0, 22.0 ],
					"text" : "pack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 99.0, 577.0, 170.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 99.0, 642.0, 45.0, 45.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 594.0, 303.0, 87.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "slide~_obj-53",
									"text" : "slide~ 500 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 614.0, 452.0, 87.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 2,
									"rnbo_uniqueid" : "slide~_obj-52",
									"text" : "slide~ 500 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 614.0, 417.0, 308.0, 23.0 ],
...
,
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "mod_index_lfo_depth",
									"rnboinfo" : 									{
										"needsInstanceInfo" : 1,
										"argnames" : 										{
											"value" : 											{
...
,
									"text" : "param mod_index_lfo_depth @min 0 @max 10. @value 0.",
									"varname" : "mod_index_lfo_depth"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 593.0, 485.0, 40.0, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 362.0, 257.0, 86.0, 23.0 ],
									"rnbo_classname" : "clamp~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "clamp~_obj-49",
									"text" : "clamp~ 0.1 10."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 383.5, 305.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 362.0, 218.0, 29.5, 23.0 ],
									"rnbo_classname" : "+~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 627.0, 135.0, 306.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"exponent" : 1.0,
...
,
									"rnbo_serial" : 2,
									"rnbo_uniqueid" : "modi_index_lfo_freq",
									"rnboinfo" : 									{
										"needsInstanceInfo" : 1,
										"argnames" : 										{
											"value" : 											{
...
,
									"text" : "param modi_index_lfo_freq @min 0 @max 10 @value 0.2",
									"varname" : "modi_index_lfo_freq"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 918.0, 266.0, 24.0, 21.0 ],
									"text" : "ms"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 831.0, 266.0, 20.0, 21.0 ],
									"text" : "%"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 868.0, 266.0, 50.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 781.0, 266.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : 0.0,
										"maximum" : 100.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 868.0, 303.0, 67.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 781.0, 303.0, 52.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 978.0, 328.0, 71.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 964.0, 266.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : 0.0,
										"maximum" : 1.0,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 964.0, 303.0, 85.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 701.0, 266.0, 50.0, 23.0 ],
									"rnbo_classname" : "number",
									"rnbo_extra_attributes" : 									{
										"minimum" : 0.0,
										"maximum" : 4.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 690.0, 162.0, 72.0, 97.0 ],
									"saved_attribute_attributes" : 									{
										"bubble_bgcolor" : 										{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 701.0, 303.0, 64.0, 23.0 ],
									"rnbo_classname" : "set",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 594.0, 386.0, 127.0, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"receivemode" : "local",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 93.0, 516.0, 101.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 3,
									"rnbo_uniqueid" : "slide~_obj-25",
									"text" : "slide~ 2500 2500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 161.0, 545.0, 101.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 4,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 229.0, 516.0, 101.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 5,
									"rnbo_uniqueid" : "slide~_obj-23",
									"text" : "slide~ 2500 2500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 297.0, 545.0, 101.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 6,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 366.0, 516.0, 101.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 7,
									"rnbo_uniqueid" : "slide~_obj-21",
									"text" : "slide~ 2500 2500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 58.0, 594.0, 276.5, 23.0 ],
									"rnbo_classname" : "biquad~",
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "biquad~_obj-20",
									"text" : "biquad~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 179.0, 423.0, 73.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 8,
									"rnbo_uniqueid" : "slide~_obj-17",
									"text" : "slide~ 40 40"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 179.0, 389.0, 202.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"exponent" : 1.0,
...
,
									"text" : "param q @value 1. @min 0.1 @max 4",
									"varname" : "q"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 93.0, 470.0, 292.0, 23.0 ],
...
,
									"rnbo_serial" : 1,
									"rnbo_uniqueid" : "filtercoeff~_obj-14",
									"rnboinfo" : 									{
										"needsInstanceInfo" : 1,
										"argnames" : 										{
											"out1" : 											{
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 92.5, 388.0, 73.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 9,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 95.0, 345.0, 463.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"exponent" : 1.0,
...
,
									"text" : "param filter @value 12000 @min 20 @max 20480 @tonormalized log2(value / 20) / 10",
									"varname" : "filter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 362.0, 168.0, 73.0, 23.0 ],
									"rnbo_classname" : "slide~",
									"rnbo_serial" : 13,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 362.0, 135.0, 257.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"fromnormalized" : "",
										"exponent" : 1.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 123.0, 689.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 57.0, 689.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"meta" : "",
										"comment" : ""
...
,
									"patching_rect" : [ 58.0, 640.0, 85.0, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"receivemode" : "local",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 149.0, 640.0, 153.0, 25.0 ],
									"style" : "rnbo-bubble",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 212.0, 304.0, 142.0, 25.0 ],
									"style" : "rnbo-bubble",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "signal" ],
									"patching_rect" : [ 40.0, 304.0, 162.0, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"receivemode" : "local",
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 877.5, 366.0, 603.5, 366.0 ],
									"source" : [ "obj-36", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-48", 0 ],
									"midpoints" : [ 790.5, 366.0, 603.5, 366.0 ],
									"source" : [ "obj-37", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-48", 0 ],
									"midpoints" : [ 973.5, 327.0, 973.0, 327.0, 973.0, 366.0, 603.5, 366.0 ],
									"source" : [ "obj-42", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-48", 0 ],
									"midpoints" : [ 710.5, 366.0, 603.5, 366.0 ],
									"source" : [ "obj-46", 0 ]
								}
						...
						"export_config" : 						{
							"cpp-export" : 							{
								"cpp-code-export" : 								{
									...
									"write_binary_file" : 0,
									"binary_file_format" : "RawFloat32Interleaved"
								}
...
,
						"poly/osc.analog[1]/smooth" : 						{
							"label" : "smooth",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"poly/osc.analog[1]/lfotype" : 						{
							"label" : "lfotype",
							"isEnum" : 1,
							"parsestring" : "\"sine\" \"ramp\" \"square\" \"rect\" \"tri\""
						}
,
						"poly/osc.analog[1]/on" : 						{
							"label" : "on",
							"isEnum" : 1,
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "4fddb01a67766732057393339a45eabc"
									}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 377.0, 40.0, 21.0 ],
					"style" : "helpfile_label",
					"text" : "Pitch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 248.0, 476.0, 72.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.0, 377.0, 57.0, 21.0 ],
					"style" : "helpfile_label",
					"text" : "Velocity"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 377.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 377.0, 53.0, 23.0 ]
				}
